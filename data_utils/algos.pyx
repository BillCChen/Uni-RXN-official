...
def floyd_warshall(adjacency_matrix):
    ...
    adj_mat_copy = adjacency_matrix.astype(numpy.long, order='C', casting='safe', copy=True)
...
def gen_edge_input(max_dist, path, edge_feat):
    ...
    path_copy = path.astype(numpy.long, order='C', casting='safe', copy=True)
    edge_feat_copy = edge_feat.astype(numpy.long, order='C', casting='safe', copy=True)
